		...
		<div class="">
			<div class="">
				...
				<div class="row" >
					...
					<div class="col-sm-4" >
						<a class="btn btn-primary pull-right" style="font-size: {{ clippings.request_btn_font_size }}px;" id="request" href="https://dashboard.petdesk.com/WebApptRequest/?placeGUID=9de183a3-4d84-4864-8839-c5f8003a9d52" onClick= "ga('set', 'dimension3', 'THEME_CAT'); ga('set', 'page', '/ZESTY/CUSTOMER_WEBSITE_BUTTONCLICK'); ga('send', 'pageview'); ga('send', 'event', 'ZESTY', 'CUSTOMER_WEBSITE_BUTTONCLICK');" >Request Appointment</a>
					</div>
				</div>
			</div>
		</div>
